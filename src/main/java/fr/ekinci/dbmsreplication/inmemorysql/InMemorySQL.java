...
public class InMemorySQL {
     ...
     */
    public <T> Collection<T> executeQuery(Class<T> returnType, String sqlQuery, Object... parameters)
     ...
     * @throws SQLException
     */
    public <T> Collection<T> executeQuery(String randDbName, Class<T> returnType, String sqlQuery, Object... parameters)
            throws SQLException, NoSuchFieldException, IllegalAccessException, InstantiationException {
